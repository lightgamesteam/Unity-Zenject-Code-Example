...
namespace NatCorder.Internal {
    ...
    public sealed class MediaRecorderAndroid : AndroidJavaProxy, IMediaRecorder {
        ...
        public MediaRecorderAndroid (AndroidJavaObject recorder, int width, int height, string recordingPath, Action<string> callback) : base(@"com.natsuite.natcorder.MediaRecorder$Callback") {
            ...
            Unmanaged = new AndroidJavaClass(@"com.natsuite.natrender.Unmanaged");
        }
