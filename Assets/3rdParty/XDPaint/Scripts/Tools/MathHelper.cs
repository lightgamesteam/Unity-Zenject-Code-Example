...
namespace XDPaint.Tools
{
    public static class MathHelper
    {
        ...
        public static Vector3 GetExitPointFromTriangle(Camera camera, Triangle triangle, Vector3 firstHit, Vector3 lastHit, Vector3 normal)
        {
            ...
            bool isIntersectedEdge1, isIntersectedEdge2, isIntersectedEdge3 = false;
            
            isIntersectedEdge1 = IsPlaneIntersectLine(normal, firstHit, triangle.Position0, triangle.Position1, out intersectionEdge1);
            isIntersectedEdge2 = IsPlaneIntersectLine(normal, firstHit, triangle.Position1, triangle.Position2, out intersectionEdge2);
