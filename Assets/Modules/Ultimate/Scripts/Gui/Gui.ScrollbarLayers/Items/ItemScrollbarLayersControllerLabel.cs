...
namespace TDL.Modules.Ultimate.GuiScrollbarLayers {
    public class ItemScrollbarLayersControllerLabel : ItemScrollbarLayersControllerBase<ItemScrollbarLayersModelLabel, ItemScrollbarLayersViewLabel> {
        protected override void ChangeOfLayer(int id, bool elementActive) {
            ...
            if (Model.EyeStateType != EyeStateType.None) {
                ...
                base.ChangeOfLayer(id, elementActive);                
            }
        }
        
        protected override void ChangeOfLayer(int id, bool layerActive, bool labelActive) {
            base.ChangeOfLayer(id, layerActive, labelActive);
            if (!Model.Id.Equals(id)) { return; }
