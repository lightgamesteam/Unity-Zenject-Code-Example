...
namespace TDL.Views
{
    public class ClassificationAssetItemView : ViewBase, IFontSizeView
    {
        ...
        {
            Signal.Fire(new ClassificationAssetItemClickViewSignal(Id));
        }
        ...
        public class Pool : MonoMemoryPool<Transform, ClassificationAssetItemView>
        {
            protected override void Reinitialize(Transform viewParent, ClassificationAssetItemView itemView)
            {
