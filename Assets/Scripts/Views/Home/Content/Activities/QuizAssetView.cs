...
namespace TDL.Views
{
    public class QuizAssetView : ViewBase, IThumbnailView, IFontSizeView
    {
        ...
        {
            Signal.Fire(new ShowFeedbackPopupFromQuizViewSignal(Id));
        }
        
        private void OnItemClick()
        {
            Signal.Fire(new QuizAssetItemClickViewSignal(Id, SelectedItemId));
        }
        ...
        public class Pool : MonoMemoryPool<Transform, QuizAssetView>
        {
            protected override void Reinitialize(Transform viewParent, QuizAssetView view)
            {
