...
namespace TDL.Views
{
    public class ActivityItemView : ViewBase, IFontSizeView
    {
        ...
        {
            Signal.Fire(new ActivityItemClickViewSignal());
        }
        ...
        public class Pool : MonoMemoryPool<Transform, ActivityItemView>
        {
            protected override void Reinitialize(Transform viewParent, ActivityItemView view)
            {
