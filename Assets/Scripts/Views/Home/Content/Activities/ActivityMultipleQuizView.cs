...
namespace TDL.Views
{
    public class ActivityMultipleQuizView : ViewBase, IFontSizeView
    {
        ...
        {
            Signal.Fire(new ActivityMultipleQuizItemClickViewSignal());
        }
        ...
        public class Pool : MonoMemoryPool<Transform, ActivityMultipleQuizView>
        {
            protected override void Reinitialize(Transform viewParent, ActivityMultipleQuizView view)
            {
