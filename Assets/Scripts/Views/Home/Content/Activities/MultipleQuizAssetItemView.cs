...
namespace TDL.Views
{
    public class MultipleQuizAssetItemView : ViewBase, IThumbnailView, IFontSizeView
    {
        ...
        {
            Signal.Fire(new MultipleQuizAssetItemClickViewSignal(Id));
        }
        ...
        public class Pool : MonoMemoryPool<Transform, MultipleQuizAssetItemView>
        {
            protected override void Reinitialize(Transform viewParent, MultipleQuizAssetItemView itemView)
            {
