...
namespace TDL.Views
{
    public class ActivityMultiplePuzzlesView : ViewBase, IFontSizeView
    {
        ...
        {
            Signal.Fire(new ActivityMultiplePuzzlesItemClickViewSignal());
        }
        ...
        public class Pool : MonoMemoryPool<Transform, ActivityMultiplePuzzlesView>
        {
            protected override void Reinitialize(Transform viewParent, ActivityMultiplePuzzlesView view)
            {
