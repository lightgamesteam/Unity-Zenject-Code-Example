...
{
    public class MainScreenOsaInitializeAssetCommand : ICommandWithParameters
    {
        ...
        public void Execute(ISignal signal)
        {
            ...
            InitializeItem(model.AssetItem, model.ClientModel);
        }

        private void InitializeItem(WebAssetItemView assetView, ClientAssetModel assetModel)
        {
            var isTeacher = false;
            if (_userLoginModel != null)
            {
                isTeacher = _userLoginModel.IsTeacher;
            }
            ...
            SaveAssetOnMainScreen(assetView);
        }
        ...
        private void SaveAssetOnMainScreen(WebAssetItemView assetView)
        {
